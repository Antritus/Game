...
public abstract class LivingEntity extends Entity {
	...
	protected void onDamageReceive(boolean cancelled, Damage damage, LivingEntity attacker) {
		...
		damageCooldown = 10;
		if (health <= 0) {
//			attacker.onKill(false, attacker, com.gmail.antcoreservices.games.laura.damage);
//			onDeath(false, attacker, com.gmail.antcoreservices.games.laura.damage);
		}
	}
	...
	public void receiveDamage(LivingEntity lastAttacker, Damage damage) { // (attacker, com.gmail.antcoreservices.games.laura.damage amount)
		onDamageReceive(false, damage, lastAttacker);
	}
	public void receiveDamage(LivingEntity lastAttacker, Damage damage, boolean trueDamage) { // (attacker, com.gmail.antcoreservices.games.laura.damage amount)
		if (damageCooldown > 0) {
			return;
		}
